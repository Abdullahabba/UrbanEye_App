...
def render_login_page():
    ...
    with tab_forgot:
        ...
        if not st.session_state["reset_verified"]:
            st.info("💡 Enter both your registered **Email Address** and **Phone Number** to proceed.")
                    ...
                    with st.spinner("Checking database for matching account..."):
                        try:
                            ...
                            if target_user:
                                ...
                                st.error("❌ Invalid credentials! No matching account found.")
                        except Exception as e:
            ...
            confirm_password = st.text_input("Confirm New Password", type="password", key="reset_conf_pass")
