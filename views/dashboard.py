...
# =========================================================
# SAFE IMPORTS WITH REAL ERROR DISPLAY
# =========================================================

try:
    from utils.metadata import get_user_metadata
except Exception as e:
    st.error(f"❌ Metadata Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Map View Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Report Tracker Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Profile View Import Error: {e}")
...
# =========================================================
# INPUT MODES - SHOW ACTUAL IMPORT ERROR
# =========================================================

try:
    from components.single_image import render_single_image_mode
except Exception as e:
    st.error(f"❌ Single Image Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Batch Processing Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Video Stream Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Live Camera Import Error: {e}")
...
try:
    ...
    st.error(f"❌ Dispatch Panel Import Error: {e}")
...
def render_dashboard_page():
    ...
    with st.sidebar:
        ...
        st.markdown(
            f"**👤 Officer:** {user_details.get('username', 'Officer')}"
        )
    ...
    if current_view == "🔍 AI Visual Detection Engine":
        ...
        st.caption(
            ...
            f"YOLO Confidence Threshold: `{conf_threshold}`"
        )
